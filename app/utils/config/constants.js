...
export const SERVER_INFO_URL = "api/v2/properties?token=";
...
// export const NIGHTSCOUT_UPDATE_INTERVAL_MS = MINUTE_IN_MS * 5  + SECOND_IN_MS * 30;
export const NIGHTSCOUT_UPDATE_INTERVAL_MS = MINUTE_IN_MS * 5  + SECOND_IN_MS * 30;
export const ALARM_UPDATE_INTERVAL = 3 * 60; //(in seconds)
// export const ALARM_UPDATE_INTERVAL = 1;
